...
public enum LayoutPageEnum {
    ...
    SYSTEM_OVERHEAT_ALARM(R.string.overheat_alarm, LayoutPageEnum.SYSTEM_HOME, true, BindingLayoutEnum.Standard),
    SYSTEM_RANGE_SETUP(R.string.range_setup, LayoutPageEnum.SYSTEM_HOME, true, BindingLayoutEnum.Standard),
    SYSTEM_SENSOR_CALIBRATION(R.string.sensor_calibration, LayoutPageEnum.SYSTEM_HOME, true, BindingLayoutEnum.Standard),
    SYSTEM_DEBUG_INFO,
    SYSTEM_FACTORY(R.string.factory_setting, LayoutPageEnum.SYSTEM_HOME, true, BindingLayoutEnum.Standard),
    SYSTEM_CONFIRM_FACTORY(R.layout.layout_confirm, R.string.confirm, LayoutPageEnum.SYSTEM_FACTORY, false, BindingLayoutEnum.Standard),
