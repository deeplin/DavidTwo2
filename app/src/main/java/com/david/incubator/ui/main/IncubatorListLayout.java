...
//        binding.skin1SensorView.setSmallLayout();
//        binding.skin2SensorView.setSmallLayout();
//        binding.skin2SensorView.setIncubatorVertical();
    }
...
//        ThemeSensorModel bodySensorModel = themeSensorRepository.getThemeSensorModel(ThemeSensorEnum.Body);
//        ThemeSensorModel machineSensorModel = themeSensorRepository.getThemeSensorModel(ThemeSensorEnum.Machine);
//
//        SensorModel skin1SensorModel = sensorModelRepository.getSensorModel(SensorModelEnum.Skin1);
//        binding.skin1SensorView.set(skin1SensorModel, bodySensorModel);
//
