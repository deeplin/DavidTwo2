...
public class SetupAlarmSpo2Layout extends BaseLayout {
    ...
    public void attach() {
        ...
        for (int rowId = 0; rowId < con)
            for (Spo2ModuleConfigEnum spo2ModuleConfigEnum : Spo2ModuleConfigEnum.activeSpo2ModuleEnumList) {
                SensorModelEnum sensorModelEnum = spo2ModuleConfigEnum.getSensorModelEnum();
